...
const NutritionInput = () => {
  const [data, setData] = useState({
    userId: 'someUserId',  // Add this as a placeholder; replace with the actual user's ID
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/api/recorddata/nutrition', data);  // Updated API endpoint
